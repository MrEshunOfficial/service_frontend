  ...
  return (
    <div className="w-full p-3">
      ...
      {filteredTasks.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">
            Tasks awaiting provider interest
          </h3>

          <p className="mt-2 max-w-md text-sm text-gray-600 dark:text-gray-400">
            These tasks haven’t been matched to a provider yet. If they fall
            within your location, you can express interest.
          </p>
        </div>
      ) : (
