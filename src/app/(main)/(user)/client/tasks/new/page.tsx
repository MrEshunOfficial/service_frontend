...
export default function NewTaskPage({ onTaskCreated }: NewTaskPageProps) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 pb-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Get matched with verified service providers in minutes
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Hero Section */}
      <div className="w-full bg-linear-to-r from-red-500 to-blue-600 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold mb-1">Post Your Task</h3>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold mb-1">Get It Done</h3>
                <p className="text-sm text-white/90">
                  Service completed on your schedule
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Fill in the details and we'll match you with the right providers
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  } rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 dark:text-white placeholder-gray-400 text-base`}
                />
                {errors.title && (
                  ...
                  <div className="p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    ...
                    {formData.latitude && formData.longitude ? (
                      ...
                      <p className="text-xs text-blue-700 dark:text-blue-300">
                        Click the button above to automatically detect your
                        current location
                      </p>
                    )}
                  ...
                  <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 space-y-3">
                    <label className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                      <input
                        ...
                        onChange={(e) => {
                          handleInputChange("flexibleDates", e.target.checked);
                          if (e.target.checked) {
                    ...
                    <label className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                      <input
                        ...
                        onChange={(e) => {
                          handleInputChange("flexibleTime", e.target.checked);
                          if (e.target.checked) {
